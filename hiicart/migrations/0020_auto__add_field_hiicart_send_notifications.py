...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HiiCart.send_notifications'
        db.add_column(u'hiicart_hiicart', 'send_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=True)


    def backwards(self, orm):
        # Deleting field 'HiiCart.send_notifications'
        db.delete_column(u'hiicart_hiicart', 'send_notifications')
